        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Audio_VideoInfo_VideoInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subtitles_VideoInfo_VideoInfoId",
                        column: x => x.VideoInfoId,
                        principalTable: "VideoInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileTitle", x => new { x.ProfileId, x.TitleId });
                    table.ForeignKey(
                        name: "FK_ProfileTitle_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileTitle_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileEpisode", x => new { x.ProfileId, x.EpisodeId });
                    table.ForeignKey(
                        name: "FK_ProfileEpisode_Episodes_EpisodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieTitleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Videos_Movies_MovieTitleId",
                        column: x => x.MovieTitleId,
                        principalTable: "Movies",
                        principalColumn: "TitleId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Videos_VideoInfo_VideoInfoId",
                        column: x => x.VideoInfoId,
                        principalTable: "VideoInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "ProfileEpisode",
                column: "EpisodeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileTitle_TitleId",
                table: "ProfileTitle",
                column: "TitleId");
